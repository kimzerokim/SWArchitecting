...
public final class TypeAdapters
{
  ...
  public static final TypeAdapter<Calendar> CALENDAR = new TypeAdapter() { private static final String YEAR = "year";
    ...
    public Calendar read(JsonReader in) throws IOException { if (in.peek() == JsonToken.NULL) {
        in.nextNull();
        return null;
      }
      in.beginObject();
  ...
  public static <TT> TypeAdapterFactory newFactory(Class<TT> type, final TypeAdapter<TT> typeAdapter)
  {
    return new TypeAdapterFactory()
    {
      ...
      public String toString() {
        return "Factory[type=" + this.val$type.getName() + ",adapter=" + typeAdapter + "]";
      }
    };
  }
  ...
  public static <TT> TypeAdapterFactory newFactory(Class<TT> unboxed, final Class<TT> boxed, final TypeAdapter<? super TT> typeAdapter)
  {
    return new TypeAdapterFactory()
    {
      ...
      public String toString() {
        return "Factory[type=" + boxed.getName() + "+" + this.val$unboxed.getName() + ",adapter=" + typeAdapter + "]";
      }
    };
  }
  ...
  public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(Class<TT> base, final Class<? extends TT> sub, final TypeAdapter<? super TT> typeAdapter)
  {
    return new TypeAdapterFactory()
    {
      ...
      public String toString() {
        return "Factory[type=" + this.val$base.getName() + "+" + sub.getName() + ",adapter=" + typeAdapter + "]";
      }
    };
  }
  ...
  public static <TT> TypeAdapterFactory newTypeHierarchyFactory(Class<TT> clazz, final TypeAdapter<TT> typeAdapter)
  {
    return new TypeAdapterFactory()
    {
      ...
      public String toString() {
        return "Factory[typeHierarchy=" + this.val$clazz.getName() + ",adapter=" + typeAdapter + "]";
      }
    };
  }
